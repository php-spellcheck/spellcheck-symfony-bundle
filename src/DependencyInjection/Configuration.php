    ...
    private function translationsNode(): NodeDefinition
    {
        ...
        $node
            ...
            ->children()
                ...
                ->end()
                ->arrayNode('paths')
                    ->info('Directories, files, or glob patterns. "*" stops at the directory separator, "**" crosses it: %kernel.project_dir%/src/**/translations.')
                    ->example(['%kernel.project_dir%/translations', '%kernel.project_dir%/src/**/*.yml'])
                    ->scalarPrototype()->end()
    ...
    private function codeNode(): NodeDefinition
    {
        ...
        $node
            ...
            ->children()
                ...
                ->arrayNode('paths')
                    ->info('Directories, files, or glob patterns, like translations.paths.')
                    ->example(['%kernel.project_dir%/src', '%kernel.project_dir%/src/**/Entity'])
                    ->scalarPrototype()->end()
